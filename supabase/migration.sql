...
create policy "Anyone can view payout requests"
...
create policy "Anyone can update payout requests"
  on public.payout_requests for update
  using (true);

-- Anyone can delete campaigns (needed for admin)
create policy "Anyone can delete campaigns"
  on public.campaigns for delete
  using (true);

-- Anyone can delete donations (needed for campaign deletion)
